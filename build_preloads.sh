...
balena preload ./preload/mf_connectors_rpi4_preload_${buildver}_${connectorver}.img --fleet chris88/mobiusflow_connectors_rpi4
...
balena preload  ./preload/mf_connectors_rpi5_preload_${buildver}_${connectorver}.img --fleet chris88/mobiusflow_connectors_rpi5
